...
**1. Investiga un poco de la distribución de Poisson, y da un ejemplo de un experimento o suceso en el que es común que sea utilizado.** \* [Tu investigación y ejemplo aquí. Tip: Piensa en conteo de eventos por unidad de tiempo o espacio, como llamadas a un conmutador].
