...
Dado que tenemos una muestra aleatoria independiente $X_1, X_2, ..., X_n$, la función de verosimilitud conjunta es el producto de las funciones de probabilidad individuales:
$$
